...
const news = [
  {
    ...
    category: 'market',
    sentiment: 'positive',
    summary: '中国人民银行今日宣布下调金融机构存款准备金率0.25个百分点，释放长期资金约5000亿元...',
  },
  {
    id: '2',
  ...
  },
  {
    ...
    category: 'economy',
    sentiment: 'positive',
    summary: '多位美联储官员在最新讲话中暗示，考虑到通胀压力缓解，可能暂停加息周期...',
  },
]
  ...
  return (
    <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            ...
            <div className="flex items-start justify-between mb-2">
              <div className="flex-1">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  >
                    {item.category === 'market' && '市场'}
                    {item.category === 'stocks' && '股票'}
                    {item.category === 'economy' && '经济'}
                    {item.category === 'crypto' && '加密货币'}
                    {item.category === 'real-estate' && '房地产'}
                    {item.category === 'bonds' && '债券'}
                  </span>
      ...
      <div className="mt-6 pt-4 border-t border-gray-200">
        <h4 className="text-sm font-medium text-gray-900 mb-3">订阅主题</h4>
        <div className="flex flex-wrap gap-2">
          {['市场动态', '股票分析', '经济政策', '房地产', '投资理财'].map((topic) => (
            <button
              key={topic}
